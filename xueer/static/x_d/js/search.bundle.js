...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBox = function (_React$Component) {
		...
		function SearchBox() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(SearchBox).call(this));
		}
	
		_createClass(SearchBox, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement('input', { id: 'inputBox', type: 'text', className: 'input va_item', placeholder: '课程名、标签', onFocus: this.props.onFocusHandler, onBlur: this.props.onBlurHandler, onChange: this.props.onChangeHandler });
			}
		}]);
	...
	var PopBox = function (_React$Component2) {
		_inherits(PopBox, _React$Component2);
	
		function PopBox() {
			_classCallCheck(this, PopBox);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(PopBox).call(this));
		}
		...
		_createClass(PopBox, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ style: !this.props.isFocus && !this.props.isBoxClicked ? styles.hide : styles.show, className: 'pop_box' },
					this.props.children
				);
			}
		}]);
	...
	var PopList = function (_React$Component3) {
		...
		function PopList() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(PopList).call(this));
		}
		...
		_createClass(PopList, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ style: this.props.hasResult ? styles.show : styles.hide, className: 'pop_list' },
					this.props.children
				);
			}
		}]);
	...
	var PopListItem = function (_React$Component4) {
		_inherits(PopListItem, _React$Component4);
	
		function PopListItem() {
			_classCallCheck(this, PopListItem);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(PopListItem).call(this));
		}
	
		_createClass(PopListItem, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'a',
					{ className: 'item', href: this.props.data.url },
	...
	var TagBox = function (_React$Component5) {
		_inherits(TagBox, _React$Component5);
	
		function TagBox() {
			_classCallCheck(this, TagBox);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(TagBox).call(this));
		}
	...
	var HotTags = function (_React$Component6) {
		_inherits(HotTags, _React$Component6);
		...
		_createClass(HotTags, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ style: this.props.isTyping && this.props.hasResult ? styles.hide : styles.show, className: 'hot_tags' },
					_react2.default.createElement(
						'div',
						{ className: 'tag_title', onClick: this.props.onClickHandler },
						_react2.default.createElement(
							'a',
							{ href: '/login' },
							'大家都在搜'
	...
	var SearchComponent = function (_React$Component7) {
		_inherits(SearchComponent, _React$Component7);
	
		function SearchComponent() {
			_classCallCheck(this, SearchComponent);
	
			var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(SearchComponent).call(this));
			...
			_this7._onFocusHandler = _this7._onFocusHandler.bind(_this7);
			_this7._onBlurHandler = _this7._onBlurHandler.bind(_this7);
			_this7._onChangeHandler = _this7._onChangeHandler.bind(_this7);
			_this7._onMouseDownHandler = _this7._onMouseDownHandler.bind(_this7);
			return _this7;
		}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(HotTags, { isTyping: this.state.isTyping, hasResult: this.state.hasResult }),
						_react2.default.createElement(
							PopList,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(143);
	  var ReactComponentTreeDevtool = __webpack_require__(116);
