...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (e, n, t) {
	        ...
	        for (var a in y) {
	            if (y.hasOwnProperty(a)) {
	                if (e = [], n = y[a], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) {
	                    ...
	                    s = e[i], f = s.split("."), 1 === f.length ? Modernizr[f[0]] = o : (!Modernizr[f[0]] || Modernizr[f[0]] instanceof Boolean || (Modernizr[f[0]] = new Boolean(Modernizr[f[0]])), Modernizr[f[0]][f[1]] = o), C.push((o ? "" : "no-") + f.join("-"));
	                }
	            }
	        }
	    }
	    ...
	    function m(e, n, o, f) {
	        ...
	        for (var p, d, m, h, v, y = ["modernizr", "tspan"]; !b.style;) {
	            p = !0, b.modElem = l(y.shift()), b.style = b.modElem.style;
