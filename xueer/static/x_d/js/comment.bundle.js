...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = function (_React$Component3) {
		...
		_createClass(CommentBox, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'form',
					{ action: '/add_comment/', method: 'post', className: 'form' },
	...
	if (document.querySelector("#xinput_warpper")) {
		_reactDom2.default.render(_react2.default.createElement(SearchComponent, null), document.querySelector("#input_warpper"));
	}
