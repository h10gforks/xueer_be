...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    var regEvent = function regEvent(node, event, func) {
	        if (node.addEventListener) node.addEventListener(event, func);else if (node.attachEvent) node.attachEvent("on" + event, func);else node["on" + event] = func;
	    };
